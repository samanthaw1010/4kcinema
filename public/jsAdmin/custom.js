...
(function (jQuery) {
    ...
    jQuery(document).ready(function () {
        ...
        jQuery(".iq-accordion .iq-accordion-block:first")
       ...
       -----------------------------------------------------------------------*/
        ...
        jQuery(document).on("click", function (e) {
            ...
            if (
                ...
                if (jQuery(myTargetElement).hasClass("search-toggle")) {
                    ...
                    selector = jQuery(myTargetElement)
                        .parent()
                        .parent()
                        .parent();
                ...
                if (
                    ...
                    jQuery(".navbar-list li .search-toggle").removeClass(
                        "active"
                    );
                }
        ...
        if (jQuery("#sidebar-scrollbar").length) {
            Scrollbar.init(
                document.querySelector("#sidebar-scrollbar"),
                options
            );
        }
        ...
        $("#newrealease-slider").on("afterChange", function () {
            var slick_index = $(".slick-active.slick-center").data(
                "slick-index"
            );
