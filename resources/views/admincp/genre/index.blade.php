             ...
             <div class="iq-card">
                <div class="iq-card-header d-flex justify-content-between">
                   ...
                   <div class="iq-card-header-toolbar d-flex align-items-center">
                      <a href="{{route('country.create')}}" class="btn btn-primary add-genre-btn">Thêm thể loại</a>
                   </div>
                </div>
                      ...
                      <table class="data-tables table movie_table " style="width:100%">
                         <thead>
                            <tr>
                               ...
                               <th style="width:40%;">Mô tả thể loại</th>
                         ...
                         <tbody>
                            ...
                            <tr>
                               ...
                               <td>
                                ...
                                {!! Form::open([
                                    'method'=>'POST',
                                    'route'=>['hide_genre',$cate->id],
                                    'onsubmit'=>'return confirm("Bạn muốn ẩn thể loại này?")',
                                ...
                                @elseif($cate->status == 0)
                                    {!! Form::open([
                                    'method'=>'POST',
                                    'route'=>['show_genre',$cate->id],
                                    'onsubmit'=>'return confirm("Bạn muốn hiển thị thể loại này?")',
                                    'class'=>'d-inline-block'
                                ]) !!}
                               ...
                               <td>
                                  <div class="flex align-items-center list-user-action">
                                    {{-- SỬA --}}
                                    <a href="{{route('genre.edit', $cate->id)}}" class="d-inline-block"><i class="fa-solid fa-square-pen" style="color: #b0efff; font-size: 28px"></i></a>
                                  </div>
                               </td>
                            </tr>
                            @endforeach
